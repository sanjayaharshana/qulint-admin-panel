...
class Map extends Field
{
    ...
    public static function getAssets()
    {
        switch (config('admin.map_provider')) {
            ...
            case 'openstreetmaps':
            default:
                $css = ['/vendor/qulint-admin/leaflet/leaflet.css', '/vendor/qulint-admin/leaflet/leaflet-geosearch.css'];
                $js = ['/vendor/qulint-admin/leaflet/leaflet.js', '/vendor/qulint-admin/leaflet/leaflet-geosearch.js'];
        }
