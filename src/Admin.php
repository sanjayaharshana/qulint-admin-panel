...
use Qulint\Admin\Controllers\AuthController;
use Qulint\Admin\Layout\Content;
use Qulint\Admin\Traits\HasAssets;
use Qulint\Admin\Widgets\Navbar;
...
class Admin
{
    ...
    /**
     * The Qulint Admin Panel version.
     *
     * @var string
     */
    public const VERSION = '3.0.19';
    ...
    /**
     * Returns the long version of Qulint Admin Panel.
     *
     * @return string The long application version
     */
    public static function getLongVersion()
    {
        return sprintf('Qulint Admin Panel <comment>version</comment> <info>%s</info>', self::VERSION);
    }
     ...
     * @param Closure $callable
     *
     * @return \Qulint\Admin\Layout\Content
     */
