...
namespace Qulint\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \Qulint\Admin\Grid                                                     grid($model, \Closure $callable)
 * @method static \Qulint\Admin\Form                                                     form($model, \Closure $callable)
 * @method static \Qulint\Admin\Show                                                     show($model, $callable = null)
 * @method static \Qulint\Admin\Tree                                                     tree($model, \Closure $callable = null)
 * @method static \Qulint\Admin\Layout\Content                                           content(\Closure $callable = null)
 ...
 *
 * @see \Qulint\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \Qulint\Admin\Admin::class;
    }
}
