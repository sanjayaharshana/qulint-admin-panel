...
class AdminServiceProvider extends ServiceProvider
{
    ...
    protected function registerPublishing()
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([__DIR__.'/../config' => config_path()], 'qulint-admin-config');
            $this->publishes([__DIR__.'/../resources/lang' => resource_path('lang')], 'qulint-admin-lang');
            $this->publishes([__DIR__.'/../database/migrations' => database_path('migrations')], 'qulint-admin-migrations');
            $this->publishes([__DIR__.'/../resources/assets' => public_path('vendor/qulint-admin')], 'qulint-admin-assets');
            $this->publishes([__DIR__.'/../resources/assets/test' => public_path('vendor/qulint-admin-test')], 'qulint-admin-test');
        }
    }
