...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Qulint Admin Panel name
    |--------------------------------------------------------------------------
    |
    | This value is the name of Qulint Admin Panel, This setting is displayed on the
    | login page.
    |
    */
    'name' => 'Qulint Admin Panel',

    /*
    |--------------------------------------------------------------------------
    | Qulint Admin Panel logo
    |--------------------------------------------------------------------------
    |
    ...
    |
    */
    'logo' => '<b>Qulint</b> Admin Panel',

    /*
    |--------------------------------------------------------------------------
    | Qulint Admin Panel mini logo
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Qulint Admin Panel bootstrap setting
    |--------------------------------------------------------------------------
    |
    | This value is the path of qulint-admin bootstrap file.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Qulint Admin Panel route settings
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Qulint Admin Panel install directory
    |--------------------------------------------------------------------------
    |
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => Qulint\Admin\Auth\Database\Administrator::class,
            ],
        ],
